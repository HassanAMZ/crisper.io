...
>(({ className, children }, ref) => {
  return (
    <div
      ref={ref}
      className={cn(
        "z-10 flex size-12 items-center justify-center rounded border-2 bg-white p-3 shadow-[0_0_20px_-12px_rgba(0,0,0,0.8)]",
        className
      )}
    >
      {children}
...
export function AnimatedBeamMultipleOutputDemo({
  ...
  // Center node ref (middle)
  const centerRef = useRef<HTMLDivElement>(null);

  // Output refs (right side - 5 outputs)
    ...
    >
      <div className="flex size-full max-w-lg flex-row items-stretch justify-between gap-10">
        ...
        <div className="flex flex-col justify-center gap-2">
          ...
          <Circle ref={output4Ref}>
            <Icons.user />
          </Circle>
          <Circle ref={output5Ref}>
            <Icons.googleDrive />
          </Circle>
        </div>
      </div>

      {/* AnimatedBeams from inputs to center */}
      <AnimatedBeam
      ...
      {/* AnimatedBeams from center to outputs */}
      <AnimatedBeam
        containerRef={containerRef}
        fromRef={centerRef}
        toRef={output1Ref}
